...
export default function FooterSection() {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <ul className="mt-12 flex justify-center gap-6 md:gap-8">
      <li>
        <a
          href="https://www.facebook.com/lacocina.acuna.3/"
          rel="noreferrer"
          target="_blank"
      ...
      <li>
        <a
          href="https://www.instagram.com/lacocinaestudiook/"
          rel="noreferrer"
          target="_blank"
          className="text-white transition hover:text-gray-700/75"
        >
    ...
    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-200">
      Sitio web diseñado y desarrollado por <a href="https://wa.me/543855854928" className="underline">Francisco Moyano</a>
    </p>
