...
function AboutSection() {
    return (
        <section id="about" className="bg-black bg-blend-overlay bg-cover bg-center w-full flex flex-col justify-center p-8  pl-0 pt-0 sm:p-20 sm:pl-0 sm:pt-0 md:p-0 md:mb-20 md:grid md:grid-cols-4 md:gap-2">
                ...
                <article className="md:row-start-2 md:col-start-3 md:col-end-5 md:place-self-center lg:px-10 ">
