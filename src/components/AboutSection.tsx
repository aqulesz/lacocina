...
function AboutSection() {
    return (
        <div className="bg-black bg-blend-overlay bg-cover bg-center w-full flex flex-col justify-center p-8  pl-0 pt-0 sm:p-20 sm:pl-0 sm:pt-0 md:p-10 md:pl-0 md:pt-0 md:grid md:grid-cols-2 md:gap-4 lg:gap-11 lg:h-svh">
                ...
                <img src={Guitarimg} alt="" className="rounded-r-2xl saturate-0 mb-5 md:col-start-1 md:row-start-2 md:row-end-4 md:self-center"/>
